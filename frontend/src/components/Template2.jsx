        ...
        <header className="header">
          <div className="header-title">
            <img
              src="WU.png"
              alt="Random Logo"
              style={{ height: "60px", verticalAlign: "middle", marginRight: "15px", borderRadius: "10px" }}
            />
        ...
        <div className="main-container">
          <div className="left-panel">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: leftPanel1Content }}
            />
          </div>
          ...
          <div className="left-panel">
            ...
            <div
              className="right-panel2"
              dangerouslySetInnerHTML={{ __html: leftPanel2Content }}
            />
          </div>
        </div>
