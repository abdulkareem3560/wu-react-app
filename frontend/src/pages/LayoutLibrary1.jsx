...
const LayoutLibraryAdminPortal = () => {
  ...
  const handleSaveLayout = () => {
    ...
    html2canvas(canvasRef.current).then((canvasImage) => {
      ...
      fetch(`${import.meta.env.VITE_BACKEND_BASE_URL}/layouts/save`, {
        method: "POST",
  ...
  const generateLayoutHTML = () => {
    ...
    let layoutHTML = `<!DOCTYPE html>
        ...
        <div id="canvas-container">
           <div class="canvas-object" id="fixed-canvas-object" style="position: absolute; left: 110px; top: 0px; width: 323px; min-height: 60px; background: #fff8dc; z-index: 10;">
            <div style="display:flex; justify-content: space-between;">
              <select disabled style="width:fit-content;">
                <option value="1" selected>Section 1</option>
              </select>
              <div style="background: #c2e2fc; border: 1px solid #6db6f8; height: fit-content; border-radius: 20px; padding:3px 7px;">
                <p style="margin: 0">fixed</p>
              </div>
            </div>
            <div class="dropdown-content" id="content-for-fixed-object-section-1" style="display: block;">
            </div>
          </div>
        `;
