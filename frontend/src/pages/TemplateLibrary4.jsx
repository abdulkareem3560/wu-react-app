...
const TemplateLibrary = () => {
  ...
  const handleInsertTable = useCallback(() => {
    ...
    // Create a div to wrap the table and add the delete button
    const div = document.createElement("div");
    div.style.position = "relative"; // Positioning for the delete button
  ...
  `;
    ...
    // Add the delete button with Trash icon positioned above the table
    const deleteBtn = document.createElement("button");
    deleteBtn.style.position = "absolute";
    deleteBtn.style.top = "-25px";  // Position it above the table
    deleteBtn.style.right = "10px";  // Right-align the delete button
    ...
    // Add the Trash icon using lucide-react
    const trashIconSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
  <g fill="none" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <!-- Lid -->
    <path d="M3 6h18M9 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
...
`;
    ...
    deleteBtn.innerHTML = trashIconSVG;  // Set the innerHTML to the Trash icon SVG

    // Add event listener for the delete button
    deleteBtn.addEventListener("click", () => {
      div.remove(); // Remove the table and the button from the editor
    });

    div.appendChild(deleteBtn);

    // Insert the div (with table and delete button) into the editor
