...
const TemplateLibrary = () => {
  ...
  function handleSaveWithReplacedVariables() {
    ...
    fetch(`${BACKEND_BASE_URL}save-section/${sectionKey}`, {
      method: "POST",
  ...
  function saveRules() {
    ...
    fetch(`${BACKEND_BASE_URL}save-rules/${sectionKey}`, {
  ...
  const loadSectionContent = () => {
    fetch(`${BACKEND_BASE_URL}get-section/${encodeURIComponent(section)}`)
      .then(res => res.json())
      .then(data => {
  ...
  function loadGlobalVariableKeys() {
    fetch(`${BACKEND_BASE_URL}api/global-variables`)
      .then((res) => res.json())
      .then((data) => {
  ...
  function fetchAndDisplayRulesForSection(sectionId) {
    ...
    fetch(`${BACKEND_BASE_URL}get-rules/${sectionId}`)
      .then((res) => res.json())
      .then((data) => {
        const {
          sectionRules = [], variableRules = [], sectionLogic, variableLogic = [],
  ...
  function openRuleModalForSection(sectionId) {
    ...
    fetch(`${BACKEND_BASE_URL}get-rules/${encodeURIComponent(sectionId)}`)
      .then((res) => res.json())
      .then((data) => {
        const {
